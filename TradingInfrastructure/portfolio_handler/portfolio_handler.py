...
from TradingInfrastructure.order.order import SuggestedOrder
from TradingInfrastructure.portfolio.portfolio import Portfolio
...
class PortfolioHandler(object):
    def __init__(
        ...
        The PortfolioHandler alse takes a handle to the RiskManger,
        which is used to modify any generated Orders to remain in 
    ...
    def _create_order_from_signal(self, signal_event):
        ...
        as they have yet to be sent to the RiskManger object.

        At this stage they are simply "suggestions" that the
        RiskManger will either verify, modify, eliminate.
        """
    ...
    def _place_orders_onto_queue(self, order_list):
        """
        Once the RiskManger has verified, modified or eliminated 
    ...
    def _convert_fill_to_portfolio_update(self, fill_event):
        ...
        object. This ensures that the broker and the local
        portfolio are "in sync".
    ...
    def on_signal(self, signal_event):
        ...
        to form the initila orders from the SignalEvent.

        These orders are sized by the PositionSizer object and then
        sent to the RiskManger to verify, modify or eliminate.

        Once received from the RiskManger they are converted into full
        OrderEvent objects and sent back to the events queue.
        """
    ...
    def on_fill(self, fill_event):
        ...
        they will come directly from a broker (such as Interactive Brokers)
        """
