...
from TradingInfrastructure.event.event import FillEvent, OrderEvent, SignalEvent
from TradingInfrastructure.portfolio_handler.portfolio_handler import PortfolioHandler
...
class PositionSizerMock(object):
    ...
    def size_order(self, portfolio, initial_order):
        """
        This PositionSizerMock simply modifies the quantity
        to be 100 for any share transacted.
        """
...
class RiskManagerMock(object):
    ...
    def refine_orders(self, portfolio, sized_order):
        ...
        sized order through, creates the corrisponding
        OrderEvent oject and adds it to a list
        """
...
class TestSimpleSignalOrderFillCycleForPortfolioHandler(unittest.TestCase):
    ...
    def test_create_order_from_signal_basic_check(self):
        """
        Test the "_create_order_from_signal" method
