...
class TestAmazonGooglePortfolio(unittest.TestCase):
    ...
    Google/Alphabet with various oders to create
    ...
    def setUp(self):
        """
        Set up the Portfolio object that wil store the
    ...
    def test_calculate_round_trip(self):
        ...
        # Buy 300 AMZN over two transactions
